...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = true, onClose, isMobile = false }) => {
    ...
    // Para móvil, usar overlay y sidebar deslizante
    if (isMobile) {
        return (
            <>
                {/* Overlay oscuro */}
                ...
                `}>
                    ...
                    <SidebarContent 
                        ...
                        canSee={canSee}
                        onLinkClick={onClose} // Cerrar sidebar al hacer clic en un enlace en móvil
                    />
                </aside>
            </>
        );
    ...
    // Para desktop, mostrar sidebar fijo
    return (
        <aside className="hidden lg:block w-64 bg-white shadow-lg h-[calc(100vh-4rem)] fixed left-0 top-16 overflow-y-auto border-r border-gray-200">
            <SidebarContent 
                user={user}
                stats={stats}
                exporting={exporting}
...
// Componente separado para el contenido del sidebar (reutilizable)
const SidebarContent: React.FC<{
    ...
    onLinkClick?: () => void;
}> = ({ user, stats, exporting, exportMessage, handleExportBackup, canSee, onLinkClick }) => {
    return (
        <div className="p-4">
                    ...
                    {canSee(['admin', 'asesor', 'docente']) && (
                        <li>
                            <a 
                                ...
                                onClick={onLinkClick}
                                className="flex items-center space-x-2 text-gray-700 hover:text-green-600 hover:bg-gray-50 p-2 rounded transition-colors"
                            >
                    ...
                    <div className="ml-6 space-y-2 border-l-2 border-blue-200 pl-2">
                        ...
                        <div className="ml-6 space-y-2 border-l-2 border-amber-200 pl-2">
                            <a 
                                href="/gestion/lotes" 
                                onClick={onLinkClick}
                                className="block p-2 hover:bg-amber-50 rounded"
                            >
                                <div className="flex items-center space-x-2">
                            ...
                            <div className="ml-6 space-y-1">
                                ...
                                <a 
                                    ...
                                    onClick={onLinkClick}
                                    className="block p-1 hover:bg-gray-50 rounded"
                                >
                                    <div className="flex items-center space-x-2">
