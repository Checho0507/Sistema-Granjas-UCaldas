                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-2 border rounded ${getError('nombre') ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            />
                            {getError('nombre') && (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className={`w-full p-2 border rounded ${getError('tipo') ? 'border-red-500' : 'border-gray-300'}`}
                                    required
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className={`w-full p-2 border rounded ${getError('estado') ? 'border-red-500' : 'border-gray-300'}`}
                                    required
                                >
                                ...
                                {getError('estado') && (
                                    <p className="text-red-500 text-sm mt-1">{getError('estado').replace('Value error, ', '')}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleChange}
                                className={`w-full p-2 border rounded ${getError('granja_id') ? 'border-red-500' : 'border-gray-300'}`}
                                required
                            >
                            ...
                            {getError('granja_id') && (
                                <p className="text-red-500 text-sm mt-1">{getError('granja_id').replace('Value error, ', '')}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows={3}
                                className={`w-full p-2 border rounded ${getError('descripcion') ? 'border-red-500' : 'border-gray-300'}`}
