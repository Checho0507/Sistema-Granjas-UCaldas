...
interface DiagnosticosTableProps {
    ...
    verificandoRecomendacion?: number | null;
    currentUser: any;
}
                                    ...
                                    <tr key={diagnostico.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex space-x-2">
                                                ...
                                                {onCrearRecomendacion && [1, 2, 5].includes(currentUser?.rol_id) && diagnostico.estado !== 'cerrado' && (
                                                    <button
                                                        onClick={() => onCrearRecomendacion(diagnostico)}
                                                        disabled={verificandoRecomendacion === diagnostico.id}
                                                        className="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-50 disabled:opacity-50"
                                                        title="Crear recomendación"
                                                    >
                                                        {verificandoRecomendacion === diagnostico.id
